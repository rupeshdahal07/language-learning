...
urlpatterns = [
    ...
    path('path/path-detail/<int:id>/', views.path_detail, name='path_detail'),
    ...
    path('lesson/lesson-detail/<int:id>/', views.lesson_detail, name='lesson_detail'),
    ...
    path('word-game/list/', views.list_word_games, name='list_word_games'),
    ...
    path('edit-word-game/<int:word_game_id>/', views.edit_word_game, name='edit_word_game'),
